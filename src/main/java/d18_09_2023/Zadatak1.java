...
public class Zadatak1 {
    public static void main(String[] args) {
        ...
        VideoPlayer player1= new VideoPlayer(180, 45, 75, 240);
        ...
        timeControl.namestiVreme("unapred");
        timeControl.izvrsiAkciju(player1);
        timeControl.namestiVreme("unapred");
        timeControl.izvrsiAkciju(player1);
        timeControl.namestiVreme("unazad");
        timeControl.izvrsiAkciju(player1);
        player1.stampaj();
        //proverio i radi

        audioControl.namestiZvuk("pojacaj");
        audioControl.izvrsiAkciju(player1);
        audioControl.namestiZvuk("pojacaj");
        audioControl.izvrsiAkciju(player1);
        audioControl.namestiZvuk("pojacaj");
        audioControl.izvrsiAkciju(player1);
        audioControl.namestiZvuk("pojacaj");
        audioControl.izvrsiAkciju(player1);
        audioControl.namestiZvuk("smanji");
        audioControl.izvrsiAkciju(player1);
        player1.stampaj();
        //proverio i radi


        qualityOptimizerControl.izvrsiAkciju(player1);
        player1.stampaj();
        //proverio i radi
    }
}
