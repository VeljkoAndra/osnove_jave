...
public class Zadatak2 {
    public static void main(String[] args) {
        ...
        System.out.print("Unesite vrendnost za b(mora biti vrednost 1 ili 2): ");
        int b = s.nextInt();

        if (b == 1) {System.out.println("Nova vrednost za a je: " + (a + 10));}
        if(b == 2){System.out.println("Nova vrednost za a je: " + (a - 20));}
    }
}
